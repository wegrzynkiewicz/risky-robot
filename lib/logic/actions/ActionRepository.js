...
export default class ActionRepository {
    ...
    getCodeByName(constructorName) {
        return this.getConstructorByName(constructorName).prototype[actionSymbol].code;
    }
    ...
    getNameByCode(constructorCode) {
        return this.getConstructorByName(constructorCode).prototype[actionSymbol].name;
    }
}
