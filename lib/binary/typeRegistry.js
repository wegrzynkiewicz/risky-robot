...
export default new class TypeRegistry {
    ...
    createStaticType(char, power, mapped) {
        ...
        prototype.decode = function (dataView) {
            return this['dataViewGetter'].call(dataView, this.byteOffset, true);
        };

        prototype.encode = function (dataView, instance) {
            const value = instance[this.propertyName];
    ...
    createVectorType(axis, staticType) {
        ...
        const vectorByteLength = vectorLength * staticByteLength;
        ...
        Object.defineProperty(prototype, 'byteLength', {value: vectorByteLength});
        Object.defineProperty(prototype, 'axisType', {value: staticType});
        Object.defineProperty(prototype, 'axisLength', {value: vectorLength});
        Object.defineProperty(prototype, 'arrayType', {value: staticType.prototype['arrayType']});
        Object.defineProperty(prototype, 'axisByteLength', {value: staticType.prototype['byteLength']});
    ...
    createMatrixType(matrixWidth, staticType) {
        ...
        const matrixByteLength = matrixElements * staticByteLength;
        ...
        Object.defineProperty(prototype, 'byteLength', {value: matrixByteLength});
        Object.defineProperty(prototype, 'axisType', {value: staticType});
        Object.defineProperty(prototype, 'axisLength', {value: matrixElements});
        Object.defineProperty(prototype, 'arrayType', {value: staticType.prototype['arrayType']});
        Object.defineProperty(prototype, 'axisByteLength', {value: staticType.prototype['byteLength']});
        Object.defineProperty(prototype, 'dataViewGetter', {value: staticType.prototype[`dataViewGetter`]});
        Object.defineProperty(prototype, 'dataViewSetter', {value: staticType.prototype[`dataViewSetter`]});
