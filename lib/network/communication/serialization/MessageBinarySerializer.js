...
export default class MessageBinarySerializer {
    ...
    constructor(messageRepository) {
        ...
        this.messageBinaryDescriptor = Message.prototype[binaryDescriptorSymbol];
        this.messageByteSize = this.messageBinaryDescriptor.getTotalByteSize(null);
    }

    serialize(message) {
        const actionBinaryDescriptor = message.action[binaryDescriptorSymbol];
    ...
    deserialize(arrayBuffer) {
        ...
        const actionBinaryDescriptor = actionConstructor.prototype[binaryDescriptorSymbol];
